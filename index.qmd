...
archipeligo <- readPNG(here::here("img", "PrinciplesYou - Archipeligo.png"))
```
...
archetypes %>% 
  ...
  ggplot(aes(x = x,
             y = y,
             size = n)) +
  annotation_custom(rasterGrob(archipeligo,
                               width = unit(1, "npc"),
                               height = unit(1, "npc")),
                    0, 931, 0, 551) +
  geom_point(color = TI_blue) +
  coord_cartesian(xlim = c(0, 931),
                  ylim = c(0, 551),
                  clip = "off") +
  theme_void() +
...
# How *We* Prefer to [Think]{style="color: #16958E;"}
...
# How *We* [Engage]{style="color: #83479F;"} with Others
...
# How *We* [Apply]{style="color: #B2881E;"} Ourselves
